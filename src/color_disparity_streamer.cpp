...
int main (int argc, char** argv) {
    ...
    string left_img_topic = "/endoscope/left/image_rect_color";
    string right_img_topic = "/endoscope/right/image_rect_color";
    ...
    image_transport::Publisher pub_disp_map = it.advertise("/endoscope/disparity/image", 1);
    ros::Subscriber sub_disp_map = nh.subscribe("/endoscope/disparity", 1, &disparityCallback);
    ...
    while (ros::ok()) {
        ...
        sensor_msgs::ImagePtr disp_img = cv_bridge::CvImage(std_msgs::Header(), "rgb8", disparity_color_).toImageMsg();
